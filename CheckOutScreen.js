...
export default function CheckOutScreen({ navigation, route }) {
  ...
  const handleLiberar = () => {
    if (!selectedTurma) {
      Alert.alert('Atenção', 'Por favor, selecione uma turma antes de liberar o check-out.');
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Iniciar check-out</Text>
        ...
        >
          <Text style={styles.primaryButtonText}>Liberar Check-out</Text>
        </TouchableOpacity>
      </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Ionicons name="exit" size={60} color="#4A2B6A" />
            <Text style={styles.modalTitle}>Check-out Liberado!</Text>
      ...
      <View style={styles.bottomTab}>
        ...
        <TouchableOpacity style={styles.tabItem}>
          <Ionicons name="exit" size={24} color="#4A2B6A" />
          <Text style={[styles.tabText, styles.tabTextActive]}>Check-out</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
